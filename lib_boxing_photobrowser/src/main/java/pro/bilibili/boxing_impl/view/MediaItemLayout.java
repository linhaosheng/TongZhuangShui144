...
package pro.bilibili.boxing_impl.view;
...
import pro.bilibili.boxing.model.entity.impl.VideoMedia;
import pro.bilibili.boxing_impl.BoxingResHelper;
...
/**
 * A media header for {@link } item, including image and video <br/>
 *
 * @author ChenSL
 */
public class MediaItemLayout extends FrameLayout {
    ...
    public void setMedia(BaseMedia media) {
        if (media instanceof ImageMedia) {
            ...
            TextView durationTxt = mVideoLayout.findViewById(R.id.video_duration_txt);
