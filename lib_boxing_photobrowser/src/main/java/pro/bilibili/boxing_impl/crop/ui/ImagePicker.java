package pro.bilibili.boxing_impl.crop.ui;
...
import pro.bilibili.boxing_impl.crop.bean.ImageFolder;
import pro.bilibili.boxing_impl.crop.bean.ImageItem;
import pro.bilibili.boxing_impl.crop.loader.ImageLoader;
import pro.bilibili.boxing_impl.crop.loader.OnImageSelectedListener;
...
public class ImagePicker {
    ...
    public List<OnImageSelectedListener> mImageSelectedListeners;          // 图片选中的监听回调
    ...
    public File getCropCacheFolder(Context context) {
        if (cropCacheFolder == null) {
            ...
            cropCacheFolder = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/BNQC/cropTemp/");
        }
