...
import pro.bilibili.boxing.model.BoxingBuilderConfig;
import pro.bilibili.boxing.model.BoxingManager;
import pro.bilibili.boxing.model.config.BoxingConfig;
import pro.bilibili.boxing.model.config.BoxingCropOption;
...
import pro.bilibili.boxing.utils.CameraPickerHelper;
...
//    @Override
//    public void onFinishCrop(Intent intent) {
//        if (mOnFinishListener != null) {
//            mOnFinishListener.onBoxingCropFinish(intent);
//        }
//
//    }
    ...
    public final List<BaseMedia> getHaveSelectPicture(){
        BoxingConfig boxingConfig = BoxingManager.getInstance().getBoxingConfig();
        if (boxingConfig == null){
            return null;
        }
        return boxingConfig.getHaveSelectPic();
    }
