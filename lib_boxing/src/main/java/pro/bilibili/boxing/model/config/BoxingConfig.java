...
package pro.bilibili.boxing.model.config;
...
public class BoxingConfig implements Parcelable {
    ...
    public List<BaseMedia> getHaveSelectPic(){
        return haveSelectPic;
    }
    ...
    public  BoxingConfig showCamera(boolean show) {
        this.mNeedCamera = show;
        return this;
    }

    public BoxingConfig setHaveSelectPics(List<BaseMedia>selectPics){
        this.haveSelectPic = selectPics;
        return this;
    }

    public BoxingConfig isCrop(boolean isCrop){
        this.mIsCrop = isCrop;
        return this;
    }
