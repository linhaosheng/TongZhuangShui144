...
package pro.bilibili.boxing.model;

import android.content.ContentResolver;

import pro.bilibili.boxing.model.callback.IAlbumTaskCallback;
import pro.bilibili.boxing.model.callback.IMediaTaskCallback;
import pro.bilibili.boxing.model.config.BoxingConfig;
import pro.bilibili.boxing.model.task.IMediaTask;
import pro.bilibili.boxing.model.task.impl.AlbumTask;
import pro.bilibili.boxing.model.task.impl.ImageTask;
import pro.bilibili.boxing.model.task.impl.VideoTask;
import pro.bilibili.boxing.utils.BoxingExecutor;
