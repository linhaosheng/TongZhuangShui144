...
public class StartDepositSearchAdapter extends BaseQuickAdapter<WithDrawalOrderModel.DataBean, BaseViewHolder> {
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, WithDrawalOrderModel.DataBean dataBean) {
        ...
        String with_drawal_name = "退押人 ：" + dataBean.getReturnCount();
        String with_drawal_buy_count = "退押人 ：" + dataBean.getReturnCount();
        ...
        baseViewHolder.setText(R.id.deposit_number, deposit_number)
                ...
                .setText(R.id.with_drawal_buy_count, with_drawal_buy_count)
                .setText(R.id.with_drawal_money_count, with_drawal_money_count)
                .setText(R.id.with_drawal_count, with_drawal_count)
        ;
    }
}
